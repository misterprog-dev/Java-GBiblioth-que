...
public class Login extends javax.swing.JFrame {
     ...
     */
    static ServicesAdmin J;
    private FenetrePrincipale C;
    public Login() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BIENVENUE DANS GB UFR-MI");
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(Bt_Connexion, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void Bt_ConnexionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bt_ConnexionActionPerformed
        if (Txtbox_pseudo.getText().length() == 0 || txtBox_mdp.getPassword().length == 0) {
              ...
              try {
                J = (ServicesAdmin) Naming.lookup("rmi://127.0.1.1:1099/80");
              }
...
//, adresse de la machine du client et nom de l'objet distant du client pour pouvoir l'invoquer ult�rieurementult�
                if (J.connectClient(Txtbox_pseudo.getText(), new String(txtBox_mdp.getPassword()))) {
            
                  fermer();    
                  //Constructeur graphique de la classe Client
                   C = new FenetrePrincipale(Txtbox_pseudo.getText());
